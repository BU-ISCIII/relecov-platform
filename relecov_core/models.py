...
class AnalysisManager(models.Manager):
    def create_new_analysis(self, data):
        new_analysis = self.create(
            raw_sequence_data_processing_method = data["raw_sequence_data_processing_method"]
            ...
            consensus_sequence_software_version = data["consensus_sequence_software_version"]
            ...
            if_bioinformatic_protocol_is_other_specify = data["if_bioinformatic_protocol_is_other_specify"]
...
class QcStatsManager(models.Manager):
    def create_new_qc_stats(self, data):
        new_qc_stats = self.create(
            ...
            per_Ns = data["per_Ns"],
            Number_of_variants_AF_greater_75percent = data["Number_of_variants_AF_greater_75percent"],
            Numer_of_variants_with_effect = data["Numer_of_variants_with_effect"],
        )
        return new_qc_stats
...
class QcStats(models.Model):
    ...
    Numer_of_variants_with_effect = models.CharField(max_length=100)
    created_at = models.DateTimeField(auto_now_add=True, verbose_name=("created at"))
    updated_at = models.DateTimeField(auto_now=True, verbose_name=("updated at"))
