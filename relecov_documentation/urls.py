...
urlpatterns = [
    ...
    path("ResultsInfoProcessed/", views.results_info_processed, name="results_info_processed"),
    path("ResultsInfoReceived/", views.results_info_received, name="results_info_received"),
