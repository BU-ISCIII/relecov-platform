...
APACHE_HOST_PORT=$apache_host_port
APP_UID=$app_uid
APP_GID=$app_gid
APP_SHELL=$app_shell
APP_PORT=$app_port
...
MAPBOX_STYLE_OWNER=$mapbox_style_owner
...
mapbox_access_token="$(config_value_for_service app MAPBOX_ACCESS_TOKEN "")"
mapbox_style_owner="$(config_value_for_service app MAPBOX_STYLE_OWNER mapbox)"
mapbox_style_id="$(config_value_for_service app MAPBOX_STYLE_ID light-v11)"
apache_host_port="$(config_value_for_service app APACHE_HOST_PORT 8090)"
