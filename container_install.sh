...
APP_VERSION="0.1.0"
APPLICATION_NAME="RELECOV Platform"
...
service_image_name() {
    case "$1" in
        relecov-platform) echo relecov-platform:local ;;
